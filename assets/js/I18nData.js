var I18N_DATA = {
  en: {
    ...
    text13: "",
    text14: "You can pay after each lesson or monthly (at the end of the month), by cash or bank payment. If you pay monthly, you pay only for those lessons you have attended.",
    text15: "One 30 min. piano lesson (suggested for kids and teenagers) — <b>25€</b><br>One 50 min. piano lesson (for adults) — <b>30€</b>",
    text16: "I can teach you to play piano at your place if you have an instrument. It will cost from <b>40€</b> per lesson (depending on how far do you live)",
  ...
  lt: {
    ...
    sectionTitle2: 'Mūsų studijoje jūs išmoksite',
    sectionTitle3: "Sveiki! Aš esu Oksana Karataj,",
    ...
    subtitle3: 'Individualus dėmesys kiekvienam',
    ...
    subtitle13: 'Kviečiame visus suaugusius ir vaikus nuo 4 metų išmokti skambinti pianinu.',
    ...
    text4: "Kuriame jūsų pageidaujamų dainų aranžuotes specialiai jums, taip pat pritaikome labai sudėtingus, bet patikusius kūrinius jūsų grojimo lygiui be jokio papildomo mokesčio!",
    text5: "<br />Profesionali klasikinė pianistė ir kvalifikuota pedagogė, respublikinių ir tarptautinių konkursų laureatė.<br /><br />Studijavau Katalonijos aukštojoje muzikos mokykloje Barselonoje, baigiau Atlikimo meno bei Meno pedagogikos magistrantūrų programas Lietuvos muzikos ir teatro akademijoje, turiu ilgametę koncertinio ir pedagoginio darbo patirtį.<br /><br />Manau, muzika yra vienas didžiausių pasaulio stebuklų, kurį pažinti ir suprasti yra labai įdomu. Todėl aš visada buvau įsitikinusi, kad muzikos mokymasis turėtų vykti smagiai ir be jokio streso!<br /><br />",
    text6: "",
    ...
    text9: 'Jūs išmoksite atpažinti įvairias natas bei akordus iš klausos, kas leis jums savarankiškai rinkti ir atlikti išgirstas melodijas be natų. ',
    ...
    text11: 'Jeigu jums patinka dainuoti, mes galime išmokyti jus pritarti savo dainavimui pianinu. Taip pat mūsų studijoje jūs galėsite išmokti akompanuoti profesionaliems dainininkams ir groti ansamblyje su kitais muzikantais (gitaristais, saksofonistais, bei smuikininkais).',
    text12: "Kiekvienais metais mes organizuojame muzikos vakarus įvairiose Vilniaus koncertų salėse, kur dalinamės tuo, ką spėjome išmokti. Tie, kurie nenori koncertuoti prieš kitus, gali įrašyti savo video pasirodymą be publikos.",
    text13: "",
    text14: "Mokėti už pamokas galite bankiniu pavedimu arba grynais, kas mėnesį arba po kiekvienos pamokos. Mokant mėnesio gale, jūs mokate tik už tas pamokas, kuriose buvote.<br><br>Užsiėmimai vyksta lietuvių, anglų arba rusų kalba.<br><br>Pamokų laikas derinamas individualiai.",
    text15: "30 min. (rekomenduojama vaikams ir paaugliams) — <b>25€</b><br>One 50 min. piano lesson (for adults) — <b>30€</b>",
    text16: "Pamokos gali būti vedamos ir jūsų namuose! Kaina pagal susitarimą nuo <b>40€</b>.",
    ...
    text18: "Darbo metodika parenkama individualiai pagal kiekvieno amžių, poreikius ir gebėjimus. O repertuarą renkame kartu! Grosime viską — nuo klasikinės, liaudies muzikos, džiazo iki roko ir populiarių dainų aranžuočių.",
  ...
  ru: {
    ...
    text15: "RU One 30 min. piano lesson (suggested for kids and teenagers) — <b>25€</b><br>One 50 min. piano lesson (for adults) — <b>30€</b>",
    text16: "RU I can teach you to play piano at your place if you have an instrument. It will cost from <b>40€</b> per lesson (depending on how far do you live).",
